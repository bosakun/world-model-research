...
def test_registry_finds_cross_phase_evidence():
 rows=discover();experiments={r["experiment"] for r in rows};assert "04_uncertainty/01_probabilistic_dynamics" in experiments;assert "07_planning/03_mpc" in experiments;assert "12_physical_ai/02_robot_interface" in experiments
