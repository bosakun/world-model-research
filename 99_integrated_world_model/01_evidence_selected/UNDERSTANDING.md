# 根拠に基づいて選んだ統合World Modelを理解する

このページは、`03_memory`と`90_evaluation`を読んだ後に読む。分からない式があれば飛ばし、「画像を見る」「未来を予測する」「actionを選ぶ」のどの段階かだけを追う。
...
### Imagination and control（想像と行動選択）
